...
@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="moviesid_gen")
@SequenceGenerator(name="moviesid_gen", sequenceName = "moviesid_seq",allocationSize=1)
